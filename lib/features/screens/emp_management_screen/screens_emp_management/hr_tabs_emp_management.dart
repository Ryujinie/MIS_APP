...
import 'package:ssi_mis_flutter/features/screens/emp_management_screen/tabs_emp_management/hr_emp_attendance.dart';
import 'package:ssi_mis_flutter/features/screens/emp_management_screen/tabs_emp_management/hr_emp_leave.dart';
import 'package:ssi_mis_flutter/features/screens/emp_management_screen/tabs_emp_management/hr_emp_overtime.dart';
...
class TabViewHREmpManagement extends StatefulWidget {
  const TabViewHREmpManagement({super.key});

  @override
  State<TabViewHREmpManagement> createState() =>
      _TabViewAdminEmpManagementState();
}

class _TabViewAdminEmpManagementState extends State<TabViewHREmpManagement> {
  final List<Widget> _tabViews = [
    const HREmpProfile(),
    const HREmpAttendance(),
    const HREmpOvertime(),
    const HREmpLeave(),
  ];
