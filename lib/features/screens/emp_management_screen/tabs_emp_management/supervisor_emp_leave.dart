...
import 'package:ssi_mis_flutter/global/printing/supervisor/print_leave_supervisor.dart';
...
class SupervisorEmpLeave extends StatelessWidget {
  const SupervisorEmpLeave({super.key});
                ...
                CustomElevatedButton(
                  onPressed: () => showDialog(
                      ...
                      builder: (BuildContext context) {
                        return const PrintSupervisorLeave();
                      }),
