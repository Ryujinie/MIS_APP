...
import 'package:ssi_mis_flutter/global/printing/supervisor/print_profile_supervisor.dart';
...
// =============== PROFILE TAB - Supervisor EMP MNGMT =============== //
class SupervisorEmpProfile extends StatefulWidget {
  const SupervisorEmpProfile({super.key});

  @override
  State<SupervisorEmpProfile> createState() => _SupervisorEmpProfileState();
}

class _SupervisorEmpProfileState extends State<SupervisorEmpProfile> {
                  ...
                  CustomElevatedButton(
                    onPressed: () => showDialog(
                        ...
                        builder: (BuildContext context) {
                          return const PrintSupervisorProfile();
                        }),
...
void saveButtonPressed() {
  // Define the functionality for the button press (optional)
}
