...
import 'package:ssi_mis_flutter/global/printing/manager/print_overtime_manager.dart';
...
class OvertimeManagerEmp extends StatelessWidget {
  const OvertimeManagerEmp({super.key});
                ...
                CustomElevatedButton(
                  onPressed: () => showDialog(
                      ...
                      builder: (BuildContext context) {
                        return const PrintManagerOvertime();
                      }),
