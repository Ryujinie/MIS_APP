...
import 'package:ssi_mis_flutter/features/screens/emp_management_screen/emp_form_emp_management/supervisor_job_details.dart';
...
// =============== ADD NEW EMPLOYEE - Supervisor EMP MNGMT =============== //
class SupervisorNewEmp extends StatefulWidget {
  const SupervisorNewEmp({super.key});

  @override
  State<SupervisorNewEmp> createState() => _IndexAddNewEmpSupervisorEmpMngmt();
}

// =============== INDEX MANAGEMENT - BODY NAVIGATION CLASS =============== //
class _IndexAddNewEmpSupervisorEmpMngmt extends State<SupervisorNewEmp> {
  @override
  void initState() {
    index = 0;
    super.initState();
  ...
  final _NewEmpSupervisorState _personalDetailsState = _NewEmpSupervisorState();
...
// ========================== PERSONAL DETAILS - Supervisor EMPLOYEE FORM ========================== //
class _NewEmpSupervisorState extends State<SupervisorNewEmp> {
  @override
  Widget build(BuildContext context) {
