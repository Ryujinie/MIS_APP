...
import 'package:ssi_mis_flutter/global/modals/hr_viewticket_modal.dart';

class HRTicketRecords extends StatelessWidget {
  const HRTicketRecords({super.key});
