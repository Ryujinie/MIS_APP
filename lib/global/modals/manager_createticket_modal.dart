...
class ManagerCreateTicketModal extends StatefulWidget {
  const ManagerCreateTicketModal({super.key});

  @override
  State<ManagerCreateTicketModal> createState() =>
      _ManagerCreateTicketModalState();
}

class _ManagerCreateTicketModalState extends State<ManagerCreateTicketModal> {
