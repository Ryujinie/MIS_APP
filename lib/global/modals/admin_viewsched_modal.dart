...
class AdminViewSchedule extends StatefulWidget {
  const AdminViewSchedule({super.key});

  @override
  State<AdminViewSchedule> createState() => _AdminViewScheduleState();
}
...
class _AdminViewScheduleState extends State<AdminViewSchedule> {
