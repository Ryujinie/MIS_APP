...
class ManagerViewLeave extends StatefulWidget {
  const ManagerViewLeave({super.key});

  @override
  State<ManagerViewLeave> createState() => _ViewLeaveState();
}

class _ViewLeaveState extends State<ManagerViewLeave> {
