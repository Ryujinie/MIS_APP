...
List viewTicketFiles = [];

class ManagerViewTicket extends StatefulWidget {
  const ManagerViewTicket({super.key});

  @override
  State<ManagerViewTicket> createState() => _ManagerViewTicketState();
}

class _ManagerViewTicketState extends State<ManagerViewTicket> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Row(
                        children:
                            List.generate(viewTicketFiles.length, (index) {
                          return viewTicketFiles.isNotEmpty
                              ? Row(
                                  children: [
                                    Container(
                                          ...
                                          TextButton(
                                            onPressed: () async {
                                              ...
                                              if (path != null &&
                                                  path.isNotEmpty) {
                                                final file = File(
                                                    '$path/${viewTicketFiles[index].name}');
