...
class AdminCreateDepartment extends StatelessWidget {
  const AdminCreateDepartment({super.key});

  @override
  Widget build(BuildContext context) {
    return createDepartment(context);
  }
}

createDepartment(BuildContext context) {
  showDialog(
    context: context,
