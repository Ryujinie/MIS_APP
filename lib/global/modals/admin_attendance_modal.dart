...
class AdminGenerateAttendance extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  static var startDate;

  const AdminGenerateAttendance({super.key});

  @override
  State<AdminGenerateAttendance> createState() =>
      _AdminGenerateAttendanceState();
}

class _AdminGenerateAttendanceState extends State<AdminGenerateAttendance> {
  String? selectedDept;
