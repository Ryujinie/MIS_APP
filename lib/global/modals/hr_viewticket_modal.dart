...
class HRViewTicket extends StatefulWidget {
  const HRViewTicket({super.key});

  @override
  State<HRViewTicket> createState() => _HRViewTicketState();
}

class _HRViewTicketState extends State<HRViewTicket> {
