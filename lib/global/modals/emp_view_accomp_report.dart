...
class ViewAccomplishmentReport extends StatefulWidget {
  const ViewAccomplishmentReport({super.key});

  @override
  State<ViewAccomplishmentReport> createState() =>
      _EmpViewAccomplishmentReportState();
}

class _EmpViewAccomplishmentReportState
    extends State<ViewAccomplishmentReport> {
  bool isSubmitted = false;
  FilePickerResult? result;
  PlatformFile? file;
  int fileIndex = viewEmpFiles.length;
  bool isMax = false;
  String message =
                ...
                children: [
                            ...
                            AttachmentButton(
                              onPressed: () async {
                                if (fileIndex < 5) {
                                  ...
                                  if (result != null) {
                                    setState(() {
                                      viewEmpFiles.add(result!.files.first);
                                      fileIndex++;
                                      //print(fileIndex);
                                    });
                                  }
                  ...
                  Row(
                    children: [
                      // attached files
                      Row(
                        children: List.generate(viewEmpFiles.length, (index) {
                          return viewEmpFiles.isNotEmpty
                              ? Row(
                                  children: [
                                    //
                                    Container(
