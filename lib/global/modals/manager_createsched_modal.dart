...
class ManagerCreateSchedule extends StatefulWidget {
  const ManagerCreateSchedule({
    super.key,
  });

  @override
  State<ManagerCreateSchedule> createState() => _ManagerCreateScheduleState();
}
...
class _ManagerCreateScheduleState extends State<ManagerCreateSchedule> {
