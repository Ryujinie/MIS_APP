...
class AdminCreateJobPosition extends StatelessWidget {
  const AdminCreateJobPosition({super.key});

  @override
  Widget build(BuildContext context) {
    return createJobPosition(context);
  }
}

createJobPosition(BuildContext context) {
  showDialog(
    context: context,
