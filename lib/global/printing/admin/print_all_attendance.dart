...
//Print Details output - Admin Attendance
class PrintAllAttendance extends StatefulWidget {
  const PrintAllAttendance(
  ...
  @override
  State<PrintAllAttendance> createState() => _PrintAllAttendanceState();
}

class _PrintAllAttendanceState extends State<PrintAllAttendance> {
  ...
  Widget build(BuildContext context) {
    ...
    //         .where((record) => record.date.isAtSameMomentAs(widget.startDate!))
    //         .toList();
    //   });
    // }
    ...
    //   for (var record in filteredList) {
    //     if (record.date.isBefore(widget.endDate!) ||
    //         record.date.isAtSameMomentAs(widget.endDate!)) {
    //       dateFilteredList.add(record);
    //     }
    //   }
