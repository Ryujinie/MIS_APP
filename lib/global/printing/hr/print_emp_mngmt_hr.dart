...
class PrintHREmpMngmt extends StatefulWidget {
  const PrintHREmpMngmt({super.key});

  @override
  State<PrintHREmpMngmt> createState() => _PrintHREmpMngmtState();
}

class _PrintHREmpMngmtState extends State<PrintHREmpMngmt> {
  ...
  void _onOpenButtonPressed() async {
    final documentsPath = await getDocumentsPath();
    OpenFile.open('$documentsPath/hr_emp.pdf');
  }
